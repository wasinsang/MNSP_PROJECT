...
<br>
<div class="card-body">
<a href="Edit_job_PM.php?Num_ID=<?php echo $result["Num_ID"]; ?>" ><img src="image/Edit.png" width="40" height="30"></a>
<br>
<br>
    ...
    <tr class="w3-blue">
			...
			<th width="80px">Confirm UAT</th>
			<th width="80px">UAT</th>
			<th width="80px">Diagram</th>
...
<!--------------------------- Button --------------------------->
			...
			<td><center><?php
			if($result["SO_File"] == "NO"or $result["SO_File"] == ""or $result["SO_File"] == NULL){
			echo '<font color="red"><b>NO</b></font>';
			}else{
			echo '<a href="'.$result["SO_File"].'" target="_blank"><img src="image/download2.png" width="40" height="40"></a>';
			}
			?>
            </center></td>
            <td><center><?php
			if($result["SO_Ter"] == "NO"or $result["SO_Ter"] == ""or $result["SO_Ter"] == NULL){
			echo '<font color="red"><b>NO</b></font>';
			}else{
			echo '<a href="'.$result["SO_Ter"].'" target="_blank"><img src="image/download2.png" width="40" height="40"></a>';
			}
			?>
			</center></td>
            ...
            <td><center><?php
			if($result["Confirm_UAT"] == "NO" or $result["Confirm_UAT"] == ""or $result["Confirm_UAT"] == NULL){
			echo '<font color="red"><b>NO</b></font>';
			}else{
			echo '<a href="'.$result["Confirm_UAT"].'" target="_blank"><img src="image/download2.png" width="40" height="40"></a>';
			}
			?>
			</center></td>

			<td><center><?php
			if($result["UAT"] == "NO" or $result["UAT"] == ""or $result["UAT"] == NULL){
			echo '<font color="red"><b>NO</b></font>';
			}else{
			echo '<a href="'.$result["UAT"].'" target="_blank"><img src="image/download2.png" width="40" height="40"></a>';
			}
			?>
			</center></td>
<!--------------------------- Button --------------------------->
			<td><center><?php
			if($result["Diagram"] == "NO"  or $result["Diagram"] == ""or $result["Diagram"] == NULL){
			echo '<font color="red"><b>NO</b></font>';
			}else{
			echo '<a href="'.$result["Diagram"].'" target="_blank"><img src="image/download2.png" width="40" height="40"></a>';
			}
			?>
			</center></td>
...
<!--------------------------- Show Detail --------------------------->
        ...
        <td><?php echo $result2["Date_Time"];?></td>
            ...
            <td style="text-align:right"><center><a href="edit_forum_pm.php?FR_ID=<?php echo $result2["FR_ID"]; ?>" ><img src="image/Edit.png" width="30" height="20"></a><?php echo '<a type="button" name="delete" data-name = "log" data-id="'.$result2["FR_ID"].'" class="btn  btn-xs delete"><img src="image/delete.png" width="25" height="25"></a>'?>
			</center></td>
