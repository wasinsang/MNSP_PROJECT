...
$country = '';
$query = "SELECT DISTINCT Status FROM pm_mnsp ORDER BY Status ASC";
$statement = $connect->prepare($query);
$statement->execute();
$result = $statement->fetchAll();
foreach($result as $row)
{
 $country .= '<option value="'.$row['Status'].'">'.$row['Status'].'</option>';
}
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item - Download -->
                        <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link " href="#" id="Export" onclick="exportTableToCSV('PM.csv')" role="button">
                ...
                <span id="form_response"></span>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">PM</h1>
                    <div class="form-row">
...
<script>
 ...
 $(document).ready(function(){
  ...
  function fill_datatable(filter_country = '',search = '')
  {
