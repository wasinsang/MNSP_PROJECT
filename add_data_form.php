                    ...
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="form-row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="checkbox" id="service1" name="service1" value="PM" >
                                    <div class="valid-feedback">
                                      Looks good!
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="checkbox" id="service2" name="service2" value="MNSP" > 
                                    <div class="valid-feedback">
                                      Looks good!
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="checkbox" id="service3" name="service3" value="BCP" >
                                    <div class="valid-feedback">
                                      Looks good!
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="checkbox" id="service4" name="service4" value="report" >
                                    <div class="valid-feedback">
                                      Looks good!
                                    </div>
                                </div>
