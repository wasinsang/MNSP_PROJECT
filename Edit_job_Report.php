...
<form class="needs-validation"role="form" name="form1" action="process_edit_Report.php" method="post" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
<input type="hidden" value = "<?php echo $result["Num_ID"];?>" name="Num_ID">
                        ...
                        <div id="report" class="form-group" >
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="Due_Date" name="Due_Date" placeholder="กำหนดส่ง" value="<?php echo $result["Due_Date"];?>" >
                                    <div class="valid-feedback">
                                      Looks good!
                                    </div>
                                </div>    
        ...
        <div class="col-md-5 mb-3">
        <?php
        echo '<a class="btn btn-lg btn-block btn-danger"  href="../project/forumReport.php?Num_ID='.$result["Num_ID"].'">cacel</a>'
        ?>
        </div>
        </div>
      </div>
