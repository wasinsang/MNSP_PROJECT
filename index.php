...
function fncSubmit()
{
	if(document.form1.search_bar.value == "")
	{
		alert('Please input Data');
		document.form1.search_bar.focus();
		return false;
	}	
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form name="form1" method ="get" action="search_data.php" onSubmit="JavaScript:return fncSubmit();"
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                                aria-label="Search" aria-describedby="basic-addon2" id="search_bar" name="search_bar" value="">
                            <div class="input-group-append">
                                <input class="btn btn-info" id="search_btn" role="button" type="submit">
                    ...
                    <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">All service</h6>
...
$(document).ready(function(){
    ...
    success:function(msg){
        ...
        // document.getElementById("Progress").innerHTML = (parseInt(id_numbers[3])*100/id_numbers[4])+'%';
        // document.getElementById("UAT_status").innerHTML = (parseInt(id_numbers[0])*100/id_numbers[4])+'%';
        // document.getElementById("Complete").innerHTML = (parseInt(id_numbers[2])*100/id_numbers[4])+'%';
        // document.getElementById("Hold").innerHTML = (parseInt(id_numbers[1])*100/id_numbers[4])+'%';
        // document.getElementById("SO_RE").innerHTML = (parseInt(id_numbers[6])*100/id_numbers[4])+'%';
        // document.getElementById("Customer").innerHTML = (parseInt(id_numbers[5])*100/id_numbers[4])+'%';
        // document.getElementById("Terminate").innerHTML = (parseInt(id_numbers[7])*100/id_numbers[4])+'%';
        // document.getElementById("Cancel_status").innerHTML = (parseInt(id_numbers[8])*100/id_numbers[4])+'%';
        ...
        document.getElementById("Progress").innerHTML = (parseInt(id_numbers[3]));
        document.getElementById("UAT_status").innerHTML = (parseInt(id_numbers[0]));
        document.getElementById("Complete").innerHTML = (parseInt(id_numbers[2]));
        document.getElementById("Hold").innerHTML = (parseInt(id_numbers[1]));
        document.getElementById("SO_RE").innerHTML = (parseInt(id_numbers[6]));
        document.getElementById("Customer").innerHTML = (parseInt(id_numbers[5]));
        document.getElementById("Terminate").innerHTML = (parseInt(id_numbers[7]));
        document.getElementById("Cancel_status").innerHTML = (parseInt(id_numbers[8]));
        document.getElementById("Progress_").style.width = (parseInt(id_numbers[3])*100/id_numbers[4])+'%';
        document.getElementById("UAT_").style.width = (parseInt(id_numbers[0])*100/id_numbers[4])+'%';
        document.getElementById("Complete_").style.width = (parseInt(id_numbers[2])*100/id_numbers[4])+'%';
        document.getElementById("Hold_").style.width = (parseInt(id_numbers[1])*100/id_numbers[4])+'%';
    ...
    function fill_datatable(filter_country = '')
  {
   ...
   var dataTable = $('#customer_data2').dataTable({
    ...
    "columnDefs": [
      ...
      { "width": "140px", "targets": 1 ,"className": "text-center"},
      { "width": "140px", "targets": 2 ,"className": "text-center"},
      { "width": "140px", "targets": 3 ,"className": "text-center",},
      { "width": "140px", "targets": 4 ,"className": "text-center",},
      { "width": "140px", "targets": 5 ,"className": "text-center",},
      { "width": "140px", "targets": 6 ,"className": "text-center",},
      { "width": "140px", "targets": 7 ,"className": "text-center",},
    ]
   });
