...
<br>
<div class="card-body">
<a href="Edit_job_mnsp.php?Num_ID=<?php echo $result["Num_ID"]; ?>" ><img src="image/Edit.png" width="40" height="30"></a>
<br>
<br>
...
<!--------------------------- Button --------------------------->
			...
			echo '<a href="'.$result["Diagram"].'" target="_blank"><img src="image/download2.png" width="40" height="30"></a>';
			}
			?>
			</center></td>
...
<!--------------------------- Button --------------------------->
			...
			echo '<a href="'.$result["Monitor"].'" target="_blank"><img src="image/download2.png" width="40" height="30"></a>';
			}
			?>
			</center></td>
...
<!--------------------------- Show Detail --------------------------->
        ...
        <td><?php echo $result2["Date_Time"];?></td>
            ...
            <td style="text-align:right"><center><a href="edit_forum_mnsp.php?FR_ID=<?php echo $result2["FR_ID"]; ?>" ><img src="image/Edit.png" width="30" height="20"></a><?php echo '<a type="button" name="delete" data-name = "log" data-id="'.$result2["FR_ID"].'" class="btn  btn-xs delete"><img src="image/delete.png" width="25" height="25"></a>'?>
			</center></td>
