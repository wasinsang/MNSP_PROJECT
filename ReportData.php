...
foreach($result as $row)
{
    ...
    $data2 = array(
     ...
     if($row['End_Date']<$date)
     {
      ...
      {    
    $sub_array[] = '<a style="color:blue" href="../project/forumReport.php?Num_ID='.$row["Num_ID"].'">'.$name.'</a>';
   ...
   //  $sub_array[] = '<a style="color:blue">'.$row['Customer_info'].'</a>';
    ...
    $sub_array[] = '<a style="color:blue">'.$row['Status'].'</a>';
      ...
      else
      {
        ...
        $sub_array[] = '<a style="color:red" href="../project/forumReport.php?Num_ID='.$row["Num_ID"].'">'.$name.'</a>';
    ...
    //  $sub_array[] = '<a style="color:red">'.$row['Detail'].'</a>';
   //  $sub_array[] = '<a style="color:red">'.$row['Due_Date'].'</a>';  
 }
 else
 {
    $sub_array[] = '<a href="../project/forumReport.php?Num_ID='.$row["Num_ID"].'">'.$name.'</a>';
