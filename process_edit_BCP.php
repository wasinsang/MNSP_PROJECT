...
<?php
	...
	$sql = "SELECT * FROM BCP WHERE Num_ID = '".$_POST["Num_ID"]."' ";
...
if($query) {
	...
	$url = "forumBCP.php?Num_ID=$Num_ID"; // this can be set based on whatever

	echo "Record add successfully"."<br>";
	// echo '<a href="../project/forumBCP.php?Num_ID='.$Num_ID.'" >Go to Home</a>';
	header( "Location: $url" );
