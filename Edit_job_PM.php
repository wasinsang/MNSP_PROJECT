...
<input type="hidden" value = "<?php echo $result["Num_ID"];?>" name="Num_ID">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="Start_Date" name="Start_Date" placeholder="select date" value="<?php echo $result["Start_Con"];?>" >
                                <div class="valid-feedback">
                                  Looks good!
                                </div>
                              </div>
        ...
        <div class="col-md-5 mb-3">
        <?php
        echo '<a class="btn btn-lg btn-block btn-danger"  href="../project/forumPM.php?Num_ID='.$result["Num_ID"].'">cacel</a>'
        ?>
        </div>
        </div>
      </div>
