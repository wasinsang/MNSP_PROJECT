...
<?php
  ...
  $sql2 = "SELECT * FROM forum_bcp WHERE Num_ID = '".$_GET["Num_ID"]."' ";
...
<h1>Input Detail Log Message </h1>
    <form class="form-horizontal" role="form" name="form1" action="process_add_forum_detail_BCP.php" method="post" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();">
