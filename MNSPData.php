...
$column = array('CustomerName', 'Gender', 'Address', 'City', 'PostalCode', 'Country', 'Sale', 'PreSale', 'Diagram', 'Confirm UAT', 'UAT', 'Service', 'SO No.', 'SO Document');
...
foreach($result as $row)
{
 ...
 if($row['End_Date']<$date)
 {
  ...
  {
    $sub_array[] = '<a style="color:blue" href="../project/forummnsp.php?Num_ID='.$row["Num_ID"].'">'.$name.'</a>';
  ...
  else
  {
    ...
    $sub_array[] = '<a style="color:red" href="../project/forummnsp.php?Num_ID='.$row["Num_ID"].'">'.$name.'</a>';
...
{
    $sub_array[] = '<a href="../project/forummnsp.php?Num_ID='.$row["Num_ID"].'">'.$name.'</a>';
