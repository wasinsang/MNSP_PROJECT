...
<?php
  ...
  include('connect.php');
   ...
   $sql2 = "SELECT * FROM forum_mnsp WHERE Num_ID = '".$_GET["Num_ID"]."' ";

   $query2 = mysqli_query($conn,$sql2);
 
   $resul2t=mysqli_fetch_array($query2,MYSQLI_ASSOC);
...
<h1>Input Detail Log Message </h1>
    <form class="form-horizontal" role="form" name="form1" action="process_add_forum_detail_mnsp.php" method="post" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();">

    <input type="hidden" value = "<?php echo $_GET["Num_ID"];?>" name="Num_ID">
    <input type="hidden" value = "<?php echo$result["Customer_Name"];?>" name="Customer_name">
