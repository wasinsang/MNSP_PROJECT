...
<br>
<div class="card-body">
<a href="Edit_job_Report.php?Num_ID=<?php echo $result["Num_ID"]; ?>" ><img src="image/Edit.png" width="40" height="30"></a>
<br>
<br>
...
<div class="card-body">
	...
	<div name="content" align="left">
	<a href="Add_forum_detail_Report.php?Num_ID=<?php echo $_GET["Num_ID"];?>" ><img src="image/BAdd.png" width="40" height="30"></a>
<br>
<br>
	...
	$sql2 = "SELECT * FROM forum_Report WHERE Num_ID = '".$_GET["Num_ID"]."' order by FR_ID ASC";
...
<!--------------------------- Show Detail --------------------------->
        ...
        <td><?php echo $result2["Date_Time"];?></td>
            ...
            <td style="text-align:right"><center><a href="edit_forum_report.php?FR_ID=<?php echo $result2["FR_ID"]; ?>" ><img src="image/Edit.png" width="30" height="20"></a><?php echo '<a type="button" name="delete" data-name = "log" data-id="'.$result2["FR_ID"].'" class="btn  btn-xs delete"><img src="image/delete.png" width="25" height="25"></a>'?>
			</center></td>
        </tr>
